...
const HeaderSection5 = () => {
  ...
  return (
    <>
      <header>
        <div className="h8_header-top d-none d-lg-block">
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-8 col-md-10">
                <p className="h8_header-top-text">
                  New members: get your first 7 days of turitor Premium for
                  free! <span>Unlock discount now!</span>
                </p>
              </div>
              <div className="col-lg-4 col-md-2">
                <div className="h8_header-top-social">
                  <ul>
                    <li>
                      <a href="#">
        ...
        <div
          className={`h8_header-area header-sticky ${isSticky ? "sticky" : ""}`}
          ref={headerRef}
        >
          <div className="container">
            <div className="row align-items-center">
              <div className="col-xxl-7 col-xl-8 col-lg-6 col-6">
                <div className="h8_header-left">
                  <div className="h8_header-logo">
                    <Link href="/">
                      <Image
                        width={132}
                        height={44}
                  ...
                  <div className="h8_header-menu d-none d-xl-block">
                    <HeaderMenu menuStyle="h8_main-menu" />
                  </div>
                </div>
              </div>
              <div className="col-xxl-5 col-xl-4 col-lg-6 col-6">
                <div className="h8_header-right">
                  <div className="h8_header-action d-none d-sm-flex">
                    <Link href="/sign-in" className="h8_header-login">
                      <svg
                        width="14"
                        height="16"
                        viewBox="0 0 14 16"
                    ...
                    <Link
                      href="/contact"
                      className="h8_header-btn theme-btn theme-btn-8"
                    >
                      Get in Touch
                    </Link>
                    <a href="#" className="h8_header-search">
                      <i className="fa-light fa-magnifying-glass"></i>
                    </a>
                  </div>
                  <div
                    className="header-menu-bar h8_menu-bar d-xl-none ml-10"
                    role="button"
